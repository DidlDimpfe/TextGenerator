...
public class SizeEight extends SpecificFontSize {
    ...
    public String[][] getA(Block block, Direction direction) {
        String[][] blockDataStrings = new String[4][4];
        ...
        blockDataStrings[0][3] = getRightTopNothingStair(block, direction);
        blockDataStrings[1][0] = getNormalBlock(block);
        blockDataStrings[1][1] = null;
        blockDataStrings[1][2] = null;
        blockDataStrings[1][3] = getNormalBlock(block);
        ...
        blockDataStrings[2][3] = getNormalBlock(block);
        blockDataStrings[3][0] = getNormalBlock(block);
        blockDataStrings[3][1] = null;
        blockDataStrings[3][2] = null;
        blockDataStrings[3][3] = getNormalBlock(block);
    ...
    public String[][] getB(Block block, Direction direction) {
        ...
        blockDataStrings[1][3] = getRightBottomNothingStair(block, direction);
        blockDataStrings[2][0] = getNormalBlock(block);
        blockDataStrings[2][1] = getTopSlap(block);
        blockDataStrings[2][2] = getTopSlap(block);
        blockDataStrings[2][3] = getRightTopNothingStair(block, direction);
        blockDataStrings[3][0] = getNormalBlock(block);
        blockDataStrings[3][1] = getBottomSlap(block);
        blockDataStrings[3][2] = getBottomSlap(block);
        blockDataStrings[3][3] = getRightBottomNothingStair(block, direction);
    ...
    public String[][] getC(Block block, Direction direction) {
        ...
        blockDataStrings[1][1] = null;
        blockDataStrings[1][2] = null;
        blockDataStrings[1][3] = getTopSlap(block);
        blockDataStrings[2][0] = getNormalBlock(block);
        blockDataStrings[2][1] = null;
        blockDataStrings[2][2] = null;
        blockDataStrings[2][3] = getBottomSlap(block);
        blockDataStrings[3][0] = getLeftBottomNothingStair(block, direction);
        blockDataStrings[3][1] = getNormalBlock(block);
        blockDataStrings[3][2] = getNormalBlock(block);
        blockDataStrings[3][3] = getRightBottomNothingStair(block, direction);
    ...
    public String[][] getE(Block block, Direction direction) {
        ...
        blockDataStrings[0][1] = getNormalBlock(block);
        blockDataStrings[0][2] = getNormalBlock(block);
        blockDataStrings[0][3] = getNormalBlock(block);
        blockDataStrings[1][0] = getNormalBlock(block);
        blockDataStrings[1][1] = getBottomSlap(block);
        blockDataStrings[1][2] = getBottomSlap(block);
        blockDataStrings[1][3] = null;
        blockDataStrings[2][0] = getNormalBlock(block);
        blockDataStrings[2][1] = getTopSlap(block);
        blockDataStrings[2][2] = getTopSlap(block);
        blockDataStrings[2][3] = null;
        blockDataStrings[3][0] = getNormalBlock(block);
        blockDataStrings[3][1] = getNormalBlock(block);
        blockDataStrings[3][2] = getNormalBlock(block);
        blockDataStrings[3][3] = getNormalBlock(block);
    ...
    public String[][] getG(Block block, Direction direction) {
        ...
        blockDataStrings[1][1] = null;
        blockDataStrings[1][2] = getBottomSlap(block);
        blockDataStrings[1][3] = getBottomSlap(block);
        blockDataStrings[2][0] = getNormalBlock(block);
        blockDataStrings[2][1] = null;
        blockDataStrings[2][2] = getTopSlap(block);
        blockDataStrings[2][3] = getNormalBlock(block);
    ...
    public String[][] getI(Block block, Direction direction) {
        String[][] blockDataStrings = new String[4][3];

        blockDataStrings[3][0] = getBottomSlap(block);
    ...
    public String[][] getJ(Block block, Direction direction) {
        ...
        blockDataStrings[3][0] = getLeftBottomNothingStair(block, direction);
        blockDataStrings[3][1] = getNormalBlock(block);
        blockDataStrings[3][2] = getRightBottomNothingStair(block, direction);
        blockDataStrings[3][3] = null;
    ...
    public String[][] getK(Block block, Direction direction) {
        ...
        blockDataStrings[0][3] = getRightBottomNothingStair(block, direction);
        blockDataStrings[1][0] = getNormalBlock(block);
        ...
        blockDataStrings[1][3] = null;
        blockDataStrings[2][0] = getNormalBlock(block);
        blockDataStrings[2][1] = getLeftBottomNothingStair(block, direction);
        blockDataStrings[2][2] = getRightTopNothingStair(block, direction);
        blockDataStrings[2][3] = null;
        blockDataStrings[3][0] = getNormalBlock(block);
        blockDataStrings[3][1] = null;
        blockDataStrings[3][2] = getLeftBottomNothingStair(block, direction);
        blockDataStrings[3][3] = getRightTopNothingStair(block, direction);
    ...
    public String[][] getM(Block block, Direction direction) {
        ...
        blockDataStrings[1][2] = getLeftTopNothingStair(block, direction);
        blockDataStrings[1][3] = getNormalBlock(block);
        blockDataStrings[2][0] = getNormalBlock(block);
        blockDataStrings[2][1] = getLeftBottomNothingStair(block, direction);
    ...
    public String[][] getP(Block block, Direction direction) {
        ...
        blockDataStrings[2][1] = getNormalBlock(block);
        blockDataStrings[2][2] = getNormalBlock(block);
        blockDataStrings[2][3] = getRightBottomNothingStair(block, direction);
        blockDataStrings[3][0] = getNormalBlock(block);
        blockDataStrings[3][1] = null;
        blockDataStrings[3][2] = null;
        blockDataStrings[3][3] = null;
    ...
    public String[][] getR(Block block, Direction direction) {
        ...
        blockDataStrings[2][1] = getNormalBlock(block);
        blockDataStrings[2][2] = getNormalBlock(block);
        blockDataStrings[2][3] = getTopSlap(block);
        blockDataStrings[3][0] = getNormalBlock(block);
        blockDataStrings[3][1] = null;
        blockDataStrings[3][2] = getLeftBottomNothingStair(block, direction);
        blockDataStrings[3][3] = getRightTopNothingStair(block, direction);
    ...
    public String[][] getV(Block block, Direction direction) {
        ...
        blockDataStrings[2][1] = getRightTopNothingStair(block, direction);
        blockDataStrings[2][2] = getLeftTopNothingStair(block, direction);
        blockDataStrings[2][3] = getRightBottomNothingStair(block, direction);
        blockDataStrings[3][0] = null;
        blockDataStrings[3][1] = getLeftBottomNothingStair(block, direction);
        blockDataStrings[3][2] = getRightBottomNothingStair(block, direction);
        blockDataStrings[3][3] = null;
    ...
    public String[][] getW(Block block, Direction direction) {
        ...
        blockDataStrings[1][3] = getNormalBlock(block);
        blockDataStrings[2][0] = getNormalBlock(block);
        blockDataStrings[2][1] = getRightBottomNothingStair(block, direction);
    ...
    public String[][] getX(Block block, Direction direction) {
        ...
        blockDataStrings[2][2] = getRightTopNothingStair(block, direction);
        blockDataStrings[2][3] = null;
        blockDataStrings[3][0] = getLeftTopNothingStair(block, direction);
        blockDataStrings[3][1] = getTopSlap(block);
        blockDataStrings[3][2] = getTopSlap(block);
        blockDataStrings[3][3] = getRightTopNothingStair(block, direction);
    ...
    public String[][] getY(Block block, Direction direction) {
        ...
        blockDataStrings[2][3] = null;
        blockDataStrings[3][0] = null;
        blockDataStrings[3][1] = getLeftTopNothingStair(block, direction);
        blockDataStrings[3][2] = getRightTopNothingStair(block, direction);
        blockDataStrings[3][3] = null;
    ...
    public String[][] get4(Block block, Direction direction) {
        ...
        blockDataStrings[1][2] = getLeftBottomNothingStair(block, direction);
        blockDataStrings[1][3] = null;
        blockDataStrings[2][0] = getNormalBlock(block);
    ...
    public String[][] get5(Block block, Direction direction) {
            ...
            blockDataStrings[2][3] = getNormalBlock(block);
            blockDataStrings[3][0] = getLeftBottomNothingStair(block, direction);
            blockDataStrings[3][1] = getRightTopNothingStair(block, direction);
            blockDataStrings[3][2] = getLeftTopNothingStair(block, direction);
            blockDataStrings[3][3] = getRightBottomNothingStair(block, direction);
    ...
    public String[][] getFullStop(Block block, Direction direction) {
        String[][] blockDataStrings = new String[4][1];
    ...
    public String[][] getComma(Block block, Direction direction) {
        String[][] blockDataStrings = new String[4][2];
    ...
    public String[][] getColon(Block block, Direction direction) {
        ...
        blockDataStrings[1][0] = null;
        blockDataStrings[2][0] = null;
        blockDataStrings[3][0] = getTopSlap(block);
